...
const CongratsCard = ({onClick}) => {
    ...
    return (
      <div className='fixed z-10 bg-black bg-opacity-50 inset-0 flex items-center justify-center'>
        <div className='card w-96 bg-base-100 flex p-5 items-center justify-center gap-5'>
          {message}
          <div className='btn btn-wide cursor-pointer' onClick={onClick}>
                Got it!
          </div>
        </div>
      </div>
